...
public class AdvisorController implements Initializable{
	...
	@FXML public DatePicker assignmentDate;
	@FXML public Label invalidName;
	@FXML public Label invalidFirstName;
	@FXML public Label invalidNumber;
	@FXML public Label invalidEmail;
	@FXML public Label invalidDate;
	@FXML public Label invalidAgency;
	@FXML public Label invalidBank;
	@FXML public ComboBox<String> agency;
	@FXML public ComboBox<String> bank;
	...
	void applyAdvisorChange(ActionEvent event) {
		...
		Utils.settingLabelsInvisible(invalidAgency,invalidDate,invalidEmail,invalidFirstName,invalidName,invalidNumber);
		...
		if (bank.getValue()==null){
			...
			if (assignmentDate.getValue()==null ){
				...
				cal = new GregorianCalendar(assignmentDate.getValue().getYear(),
						...
						assignmentDate.getValue().getDayOfMonth(), 
						0, 0, 0);
			...
			if (!invalidEmail.isVisible()&& !invalidDate.isVisible()
					&&!invalidFirstName.isVisible()&&!invalidName.isVisible()
					&&!invalidNumber.isVisible()&& !invalidAgency.isVisible()
